...
public class TransactionServiceImpl implements TransactionService {
    ...
    public TransactionResponse getTransactionById(Integer id) {
        Transaction transaction = transactionRepository.findById(Long.valueOf(id))
                .orElseThrow(() -> new TrxNotFoundException("Transaction not found with ID: " + id));

        List<TransactionDetail> details = transactionDetailRepository.findByTransactionId(id.longValue());
    ...
    private TransactionDetailResponse mapToTransactionDetailResponse(TransactionDetail detail) {
        return TransactionDetailResponse.builder()
                .id(Math.toIntExact(detail.getId()))
                .transactionId(Math.toIntExact(detail.getTransactionId()))
                .productId(detail.getProductId())
                .qtyTransaction(Math.toIntExact(detail.getQtyTransaction()))
